...
`);
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const base = localStorage.getItem('tmd_plugin_base') || "https://617654bb26fa.ngrok-free.app/plugin/getPreference.php";

    try {
      const resp = await fetch(`${base}/ai/chatbot_send.php`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",  // 帶 cookie / session
      ...
      addMessage('bot', "❌ Error contacting chatbot server.");
    }
  });
